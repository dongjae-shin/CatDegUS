...
discrete_grid = aq.DiscreteGrid(x_range_min=[300, 0.1, 0.005, 0], x_range_max=[550, 1.0, 0.02, 1],
                                x_step=[50, 0.1, 0.0025, 1], GP=GP)

discrete_grid.construct_grid()

print(discrete_grid.list_grids)

discrete_grid.uncertainty_sampling_discrete(synth_method='NP', n_candidates=5)  # need to fix this (See Bookmark notes)

# print(discrete_grid.X_discrete_wi, discrete_grid.X_discrete_np)
